...
5. Granted the roles mentioned in [README.md](https://github.com/terraform-google-modules/terraform-google-bootstrap/blob/master/README.md#features), as well as `roles/resourcemanager.folderCreator`
