...
- Shared VPCs with default DNS, NAT (optional), Private Service networking, VPC Service Controls (optional), Network Connectivity Center, on-premises Dedicated or Partner Interconnect, Cross-Cloud Dedicated or Partner Interconnect, and baseline firewall rules for each environment.
