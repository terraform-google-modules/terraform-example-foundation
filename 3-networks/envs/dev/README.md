...
1. 2-environments/dev executed successfully.
...
1. Copy contents of foundation to new repo `cp -R ../terraform-example-foundation/2-networks/envs/dev/* .` (modify accordingly based on your current directory)
