...
control 'gcloud-development' do
  ...
  describe command("gcloud access-context-manager perimeters describe #{dev_bu2_restricted_vpc_service_control_perimeter_name} --policy #{access_context_manager_policy_id} --format=json") do
    its(:exit_status) { should eq 0 }
    its(:stderr) { should eq '' }
  ...
  describe command("gcloud compute shared-vpc get-host-project #{dev_bu1_project_floating} --format=json") do
    its(:exit_status) { should eq 0 }
    its(:stderr) { should eq '' }
    ...
    describe "Verifies if #{dev_bu1_project_floating}" do
  ...
  describe command("gcloud compute shared-vpc get-host-project #{dev_bu2_project_floating} --format=json") do
    its(:exit_status) { should eq 0 }
    its(:stderr) { should eq '' }
    ...
    describe "Verifies if #{dev_bu2_project_floating}" do
      it 'is not attached to any host project' do
        expect(data).to be_empty
      end
    end
  ...
  describe command("gcloud compute shared-vpc get-host-project #{dev_bu1_project_restricted_id} --format=json") do
    its(:exit_status) { should eq 0 }
    its(:stderr) { should eq '' }
    ...
    describe "Verifies if #{dev_bu1_project_restricted_id}" do
  ...
  describe command("gcloud compute shared-vpc get-host-project #{dev_bu2_project_restricted_id} --format=json") do
    its(:exit_status) { should eq 0 }
    its(:stderr) { should eq '' }
    ...
    describe "Verifies if #{dev_bu2_project_restricted_id}" do
      it 'is attached to a host project' do
        expect(data).to_not be_empty
      end
    end
  ...
  describe command("gcloud compute shared-vpc get-host-project #{dev_bu1_project_base} --format=json") do
    its(:exit_status) { should eq 0 }
    its(:stderr) { should eq '' }
    ...
    describe "Verifies if #{dev_bu1_project_base}" do
      it 'is attached to a host project' do
        expect(data).to_not be_empty
      end
    end
  ...
  describe command("gcloud compute shared-vpc get-host-project #{dev_bu2_project_base} --format=json") do
    its(:exit_status) { should eq 0 }
    its(:stderr) { should eq '' }
    ...
    describe "Verifies if #{dev_bu2_project_base}" do
      it 'is attached to a host project' do
        expect(data).to_not be_empty
      end
    end
