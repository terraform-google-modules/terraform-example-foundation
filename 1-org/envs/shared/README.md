...
| domains\_to\_allow | The list of domains to allow users from in IAM. Used by Domain Restricted Sharing Organization Policy. | `list(string)` | n/a | yes |
...
| project\_labels\_base\_net\_hub | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-base-net-hub",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
| project\_labels\_billing\_logs | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-billing-logs",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
| project\_labels\_dns\_hub | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-dns-hub",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
| project\_labels\_interconnect | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-interconnect",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
| project\_labels\_logging | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-logging",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
| project\_labels\_restricted\_net\_hub | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-restricted-net-hub",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
| project\_labels\_scc | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-scc",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
| project\_labels\_secrets | Labels to apply to the project. | `map(string)` | <pre>{<br>  "application_name": "org-secrets",<br>  "billing_code": "1234",<br>  "business_code": "abcd",<br>  "env_code": "p",<br>  "environment": "production",<br>  "primary_contact": "example1",<br>  "secondary_contact": "example2"<br>}</pre> | no |
