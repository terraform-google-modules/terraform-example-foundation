...
module "standard-project-app-optional" {
  ...
  nonprod_folder_id = module.standard_project_folders-optional.nonprod_folder_id
  prod_folder_id    = module.standard_project_folders-optional.prod_folder_id
