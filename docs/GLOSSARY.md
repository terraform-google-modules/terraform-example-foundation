...
The pipeline can use **Cloud Build**, **GitHub Actions**, **GitLab Pipelines**, or **Terraform Cloud**, depending on your context, and Terraform is executed using the seed project service account.
