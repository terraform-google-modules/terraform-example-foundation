...
|------|-------------|------|---------|:--------:|
| billing\_account | Billing Account ID used in case sinks are under billing account level. Format 000000-000000-000000. | `string` | `""` | no |
| enable\_billing\_account\_sink | Verify if billing account will be logged in the sink. | `bool` | `true` | no |
...
| resource\_type | Resource type of the resource that will export logs to destination. Must be: project, organization, billing\_account or folder. | `string` | n/a | yes |
