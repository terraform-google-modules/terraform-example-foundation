...
1. Copy contents of foundation to new repo `cp -R ../terraform-example-foundation/3-networks/envs/nonprod/* .` (modify accordingly based on your current directory)
