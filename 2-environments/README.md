...
1. Merge changes to development.  Because the
   _development_ branch is a [named branch](./docs/FAQ.md), pushing your
   _development_
   branch triggers both _terraform plan_ and _terraform apply_.
   ```
