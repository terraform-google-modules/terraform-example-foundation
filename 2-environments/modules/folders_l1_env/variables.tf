...
variable "folder_name" {
  description = "The top level folder to be added to the hierarchy"
  type        = string
}

variable "folder_abbreviated_name" {
  type = string
}

variable "env_tag_value" {
  description = "The environment tag value of the top level folder to be added to the hierarchy"
  type        = string
}
