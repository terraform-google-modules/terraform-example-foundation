...
#locals {
#  base_project_id   = data.google_projects.base_dev_projects.projects[0].project_id
#  base_host_network = data.google_compute_network.base_shared_vpc
#}
...
module "base_shared_vpc_project" {
  ...
  #shared_vpc         = local.base_host_network.project
  #shared_vpc_subnets = local.base_host_network.subnetworks_self_links
